...
export default function HeroPage() {
    return (
        <div className="relative w-full flex flex-col  items-center overflow-hidden h-screen bg-gradient-to-b from-[#6ADADA] via-[#FEE6BA] to-[#326BFB] mt-[4rem]">
            ...
            <section className="boats absolute bottom-20 align-bottom bg-red-900 w-full flex justify-around">
                ...
                <div className="flex w-[100%] justify-end">
                    <div className="font-aprillia text-white text-4xl lg:text-5xl z-[10000000] text-nowrap pr-5 translate-y-18 lg:translate-y-15"> Scroll Down</div>
                    <img src="/assets/landing/arrrow.png" className="h-8 lg:h-10 z-[10000000] translate-y-18 lg:translate-y-15 pr-4 lg:pr-10" alt="down-arrow" />
                </div>
            </section>
        </div>
    );
