...
function NavbarDesktop() {
  return (
    <nav className="fixed left-0 top-0 z-50 hidden h-[100px] w-full bg-[#7D2E2E] font-custom-script text-white md:block md:h-[132px]">
      {/* Left Logo */}
      ...
      {/* Navigation Links */}
      <div className="absolute left-[50%] top-13 flex -translate-x-[50%] gap-4 font-aprillia text-base md:translate-x-0 md:gap-6 md:text-xl lg:gap-8 lg:text-2xl xl:gap-10 xl:text-2xl 2xl:gap-12 2xl:text-2xl">
        <Link href="/">Home</Link>
      ...
      <div>
        <img
          ...
          alt="Design Lower"
          className="mt-[3rem] w-full md:mt-[7.5rem] lg:mt-[7.4rem] xl:mt-[7.2rem] 2xl:mt-[7rem]"
        />
      </div>
    </nav>
  );
