...
function NavbarDesktop() {
  return (
    <nav className="fixed left-0 top-0 z-50 hidden h-[100px] w-full bg-[#7D2E2E] font-custom-script text-white md:block md:h-[110px]">
      {/* Left Logo */}
      ...
      {/* Navigation Links */}
      <div className="absolute left-[50%] top-11 flex -translate-x-[50%] gap-4 font-aprillia text-base md:translate-x-0 md:gap-8 md:text-3xl lg:gap-8 lg:text-4xl xl:gap-13 xl:text-4xl 2xl:gap-16 2xl:text-4xl">
