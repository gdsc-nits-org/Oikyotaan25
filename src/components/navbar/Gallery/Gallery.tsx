...
const Gallery: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <img src="/assets/gallery/img1.png" alt="" className="absolute mobile:h-[40vw] laptop:h-[25rem] mobile:top-[13%] laptop:top-[11%] left-[2%]" />

        <div >
          <h1 className="relative font-aprillia mx-auto mobile:text-3xl laptop:text-8xl z-10 translate-y-[220%]">Photo Gallery</h1>
          <img
        ...
        <div className="absolute mobile:w-[32vw] mobile:h-[32vh] laptop:w-[42vh] laptop:h-[42vh] mobile:top-[15%] laptop:top-[13%] right-0">
          <img
...
:
        <div className="mobile:h-[25vh] laptop:h-[55vh]" />
          ...
          {images.map((img, index) => {
            ...
            return (
              <div
                ...
                style={styles}
              >
                <div className="mobile:h-[50vw] mobile:w-[70vw] laptop:h-[47vh] laptop:w-[64vh] bg-[url('/assets/gallery/img7.png')] bg-contain bg-center mobile:px-7 laptop:px-11.5 items-center justify-center flex">
                  <img src={img.image} alt="" />
                </div>
                <img
                  src="/assets/gallery/Group.png"
                  alt=""
                  className="relative mobile:h-[6.5rem] laptop:h-[12rem] mx-auto mobile:-translate-y-[1.5rem] laptop:-translate-y-[3.2rem] -z-10"
                />
              </div>
            );
          })}
        ...
        <div className="mobile:-translate-y-[13rem] laptop:-translate-y-[7rem] relative z-10">
          <img src="/assets/gallery/grp2.png" alt="" 
          className="scale-125 laptop:scale-100"/>
          <img
            src="/assets/gallery/grp3.png"
            alt=""
            className="absolute top-0 laptop:top-[2rem] mobile:scale-125 laptop:scale-100 mobile:-left-[4rem] laptop:-left-[16rem] w-full z-30 animate-horizontal2"
          />
          <img
