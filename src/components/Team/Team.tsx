...
const Team = () => {
    ...
    const teamMembers = [
        { 
            ...
            name: "Rohit Sharma",
            designation: "UI/Ux Co Head",
            image: "/assets/team/person.png",
  ...
  return (
    <>
        <div className="bg-[url('/assets/team/bg-team.png')] bg-[#E3C7A1] bg-fixed bg-cover bg-center min-h-screen flex flex-col  ">
            ...
            <div className="hidden laptop:flex tablet:flex flex-col justify-center items-center gap-10 py-10 overflow-hidden">
                <div className=" flex flex-row justify-center items-center laptop:gap-28 tablet:gap-4">
                    <TeamMemberCard 
                        image="/assets/team/person.png"
                        name="Rahul Sharma"
                        designation="UI/UX Co Head"
