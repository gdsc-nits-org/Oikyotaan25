  ...
  const TeamMemberCard: React.FC<TeamMemberCardProps> = ({
    ...
    <div className=" group flex justify-center items-center lg:w-[300px] lg:h-[400px] laptop:w-[300px] laptop:h-[400px] tablet:w-[180px] tablet:h-[360px] md:w-[250px] md:h-[350px]  bg-[#fdf6e9] bg-[url('/assets/team/card-bg-before.png')] bg-cover bg-center mix-blend-multiply isolate hover:bg-[url('/assets/team/card-bg-after.png')] shadow-lg overflow-hidden relative transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] cursor-pointer  mobile:w-[320px] mobile:h-[420px] mobile:my-3">
        <div className="flex flex-col laptop:gap-0 laptop:group-hover:gap-4 tablet:gap-0 tablet:group-hover:gap-4 mobile:gap-6 mobile:group-hover:gap-4 justify-center items-center laptop:h-[86%] laptop:w-[85%] ">
                 {/* Profile Image */}
            <div className="laptop:h-[90%] laptop:w-[85%] tablet:h-[65%] tablet:w-[70%] mobile:w-[70%] mobile:h-[30%] group-hover:h-[90%] group-hover:w-[70%] mobile:group-hover:h-[70%] laptop:pt-3  tablet:pt-0 mobile:pt-3 overflow-hidden group-hover:rounded-full mobile:group-hover:rounded-full">
                <img
                src={image}
                alt={name}
