...
export default function Card({ data }: CardProps) {
  return (
    <div className="relative z-2 flex h-auto w-full items-center justify-center bg-[rgba(125,46,46,1)] py-4 md:mt-12 md:px-2">
      <div
      ...
      <div className="flex h-auto w-[85%] flex-col-reverse items-center justify-center gap-2 px-2 py-6 md:flex-row md:justify-between md:px-8">
        <div className="flex h-auto w-[100%] flex-col md:h-[500px] md:w-[50%] md:justify-center md:py-4">
          {/* Content */}
          <h1 className="mt-2 mb-6 px-2 py-2 text-center font-bold text-4xl">
            {data.title}
          </h1>
        ...
        <div className="my-2 w-[100%] md:h-[100%] md:w-[45%]">
          <img
